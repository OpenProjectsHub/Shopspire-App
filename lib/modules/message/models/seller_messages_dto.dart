...
class SellerDto extends Equatable {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'shopspirewner_id': shopOwnerId,
      'shopspirewner': shopOwner,
      'shop_name': shopName,
      'shopspirer_vendor_id': shopVendorId,
      'shop_slug': shopSlug,
      'shop_logo': shopLogo,
  ...
  factory SellerDto.fromMap(Map<String, dynamic> map) {
    return SellerDto(
      shopOwnerId: map['shopspirewner_id'] != null
          ? int.parse(map['shopspirewner_id'].toString())
          : 0,
      shopOwner: map['shopspirewner'] as String,
      shopName: map['shop_name'] as String,
      shopVendorId: map['shopspirer_vendor_id'] != null
          ? int.parse(map['shopspirer_vendor_id'].toString())
          : 0,
